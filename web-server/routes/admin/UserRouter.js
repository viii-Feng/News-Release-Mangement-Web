...
const upload = multer({ dest: 'public/avataruploads/' })// 数据在服务器,地址存在数据库
...
UserRouter.get("/adminapi/user/list1/:pageNo/:limit",UserController.getList1)// 获取用户数据接口(用户列表)
UserRouter.get("/adminapi/user/list2/:id",UserController.getList2)// 获取用户数据接口(单一用户,编辑用户)
