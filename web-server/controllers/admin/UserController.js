...
const UserController = {
    ...
    getList1: async (req, res) => {
        console.log("get");
        const result1 = await UserService.getList1({pageNo:req.params.pageNo,limit:req.params.limit})
        console.log(result1)
        const result2 = await UserService.getTotal()
        console.log(result2)
        res.send({
            ActionType:"OK",
            data:result1,
    ...
    getList2: async (req, res) => {
        const result = await UserService.getList2({_id:req.params.id})
        res.send({
            ActionType:"OK",
            data:result,
        })
